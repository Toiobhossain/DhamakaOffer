<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="showallpost.aspx.cs" Inherits="Dhamaka_offer.showallpost" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <body style="background-image:url(image/lo.jpg)">
    <br />
    <center><h1 style="color:yellow">Discount/Offer <span style="color:red">Related All post here</span></h1></center>
    <br />
    <br />
    <br />
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#999999" BorderStyle="None" BorderWidth="1px" CellPadding="3" GridLines="Vertical" OnSelectedIndexChanged="GridView1_SelectedIndexChanged">
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="OFFERImage">
                ...
                <ItemTemplate>
                    <asp:Image ID="Image1" runat="server" Width="220" Height="220" ImageUrl='<%# Eval("image") %>' />
                </ItemTemplate>
            </asp:TemplateField>
